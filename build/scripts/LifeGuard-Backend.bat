...
set CLASSPATH=%APP_HOME%\lib\LifeGuard-Backend-0.0.14.jar;%APP_HOME%\lib\twilio-10.0.0-rc.6.jar;%APP_HOME%\lib\helidon-integrations-openapi-ui-3.2.2.jar;%APP_HOME%\lib\helidon-openapi-3.2.2.jar;%APP_HOME%\lib\helidon-health-checks-3.2.2.jar;%APP_HOME%\lib\helidon-health-3.2.2.jar;%APP_HOME%\lib\helidon-metrics-3.2.2.jar;%APP_HOME%\lib\helidon-metrics-service-api-3.2.2.jar;%APP_HOME%\lib\helidon-service-common-rest-3.2.2.jar;%APP_HOME%\lib\helidon-webserver-static-content-3.2.2.jar;%APP_HOME%\lib\helidon-webserver-cors-3.2.2.jar;%APP_HOME%\lib\helidon-webserver-3.2.2.jar;%APP_HOME%\lib\helidon-media-jsonp-common-2.0.0-M3.jar;%APP_HOME%\lib\helidon-microprofile-tests-junit5-3.2.2.jar;%APP_HOME%\lib\helidon-config-yaml-mp-3.2.2.jar;%APP_HOME%\lib\helidon-config-yaml-3.2.2.jar;%APP_HOME%\lib\postgresql-42.6.0.jar;%APP_HOME%\lib\commons-codec-1.15.jar;%APP_HOME%\lib\commons-io-2.7.jar;%APP_HOME%\lib\jjwt-jackson-0.11.2.jar;%APP_HOME%\lib\jjwt-impl-0.11.2.jar;%APP_HOME%\lib\jjwt-api-0.11.2.jar;%APP_HOME%\lib\httpclient-4.5.13.jar;%APP_HOME%\lib\httpcore-4.4.13.jar;%APP_HOME%\lib\jackson-dataformat-xml-2.14.0.jar;%APP_HOME%\lib\jackson-annotations-2.14.0.jar;%APP_HOME%\lib\smallrye-open-api-jaxrs-2.1.16.jar;%APP_HOME%\lib\smallrye-open-api-core-2.1.16.jar;%APP_HOME%\lib\jackson-dataformat-yaml-2.14.0.jar;%APP_HOME%\lib\jackson-datatype-jsr310-2.14.0.jar;%APP_HOME%\lib\jackson-databind-2.14.0.jar;%APP_HOME%\lib\jackson-core-2.14.0.jar;%APP_HOME%\lib\slf4j-api-1.7.30.jar;%APP_HOME%\lib\helidon-media-jsonp-3.2.2.jar;%APP_HOME%\lib\helidon-common-key-util-3.2.2.jar;%APP_HOME%\lib\helidon-fault-tolerance-3.2.2.jar;%APP_HOME%\lib\helidon-common-configurable-3.2.2.jar;%APP_HOME%\lib\helidon-logging-common-3.2.2.jar;%APP_HOME%\lib\helidon-tracing-3.2.2.jar;%APP_HOME%\lib\helidon-metrics-api-3.2.2.jar;%APP_HOME%\lib\helidon-config-testing-3.2.2.jar;%APP_HOME%\lib\helidon-media-common-3.2.2.jar;%APP_HOME%\lib\helidon-tracing-config-3.2.2.jar;%APP_HOME%\lib\helidon-config-mp-3.2.2.jar;%APP_HOME%\lib\helidon-config-3.2.2.jar;%APP_HOME%\lib\helidon-common-media-type-3.2.2.jar;%APP_HOME%\lib\helidon-common-http-3.2.2.jar;%APP_HOME%\lib\helidon-common-reactive-3.2.2.jar;%APP_HOME%\lib\helidon-common-mapper-3.2.2.jar;%APP_HOME%\lib\helidon-jersey-client-3.2.2.jar;%APP_HOME%\lib\helidon-common-context-3.2.2.jar;%APP_HOME%\lib\helidon-common-service-loader-3.2.2.jar;%APP_HOME%\lib\yasson-2.0.4.jar;%APP_HOME%\lib\jakarta.json-2.0.0.jar;%APP_HOME%\lib\jakarta.json-2.0.0-module.jar;%APP_HOME%\lib\snakeyaml-2.0.jar;%APP_HOME%\lib\jandex-2.4.3.Final.jar;%APP_HOME%\lib\microprofile-openapi-api-3.0.jar;%APP_HOME%\lib\smallrye-open-api-ui-2.1.16.jar;%APP_HOME%\lib\helidon-common-3.2.2.jar;%APP_HOME%\lib\netty-codec-http-4.1.94.Final.jar;%APP_HOME%\lib\netty-handler-4.1.94.Final.jar;%APP_HOME%\lib\jersey-client-3.0.9.jar;%APP_HOME%\lib\jersey-hk2-3.0.9.jar;%APP_HOME%\lib\jersey-common-3.0.9.jar;%APP_HOME%\lib\jakarta.enterprise.cdi-api-3.0.0.jar;%APP_HOME%\lib\jakarta.interceptor-api-2.0.0.jar;%APP_HOME%\lib\jakarta.annotation-api-2.0.0.jar;%APP_HOME%\lib\microprofile-health-api-4.0.jar;%APP_HOME%\lib\helidon-health-common-3.2.2.jar;%APP_HOME%\lib\microprofile-metrics-api-4.0.jar;%APP_HOME%\lib\checker-qual-3.31.0.jar;%APP_HOME%\lib\commons-logging-1.2.jar;%APP_HOME%\lib\woodstox-core-6.4.0.jar;%APP_HOME%\lib\stax2-api-4.2.1.jar;%APP_HOME%\lib\parsson-1.0.2.jar;%APP_HOME%\lib\jakarta.json-api-2.0.2.jar;%APP_HOME%\lib\junit-platform-commons-1.7.0.jar;%APP_HOME%\lib\junit-jupiter-api-5.7.0.jar;%APP_HOME%\lib\hamcrest-all-1.3.jar;%APP_HOME%\lib\netty-codec-4.1.94.Final.jar;%APP_HOME%\lib\netty-transport-native-unix-common-4.1.94.Final.jar;%APP_HOME%\lib\netty-transport-4.1.94.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.94.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.94.Final.jar;%APP_HOME%\lib\netty-common-4.1.94.Final.jar;%APP_HOME%\lib\microprofile-config-api-3.0.1.jar;%APP_HOME%\lib\jboss-logging-3.4.2.Final.jar;%APP_HOME%\lib\jakarta.json.bind-api-2.0.0.jar;%APP_HOME%\lib\jakarta.xml.bind-api-3.0.1.jar;%APP_HOME%\lib\jakarta.inject-api-2.0.1.jar;%APP_HOME%\lib\apiguardian-api-1.1.0.jar;%APP_HOME%\lib\opentest4j-1.2.0.jar;%APP_HOME%\lib\jakarta.ws.rs-api-3.0.0.jar;%APP_HOME%\lib\hk2-locator-3.0.3.jar;%APP_HOME%\lib\javassist-3.29.0-GA.jar;%APP_HOME%\lib\jakarta.activation-2.0.1.jar;%APP_HOME%\lib\jakarta.el-api-4.0.0.jar;%APP_HOME%\lib\osgi-resource-locator-1.0.3.jar;%APP_HOME%\lib\hk2-api-3.0.3.jar;%APP_HOME%\lib\aopalliance-repackaged-3.0.3.jar;%APP_HOME%\lib\hk2-utils-3.0.3.jar
